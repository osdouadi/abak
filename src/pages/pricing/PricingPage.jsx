...
import { sendpricingRequest } from '../../services/forms';
...
function PricingPage() {
  ...
  const { mutate: mutateNew, isPending } = useMutation({
    mutationFn: (formData) => {
      return sendpricingRequest(formData);
    },
    onSuccess: (data) => {
  ...
  return (
    <div>
      <Banner className="page-banner h-[220px] md:h-[400px] mb-1 md:mb-2 lg:mb-5"></Banner>
          ...
          <div className="flex flex-col items-center ">
            ...
            <div className="form mx-auto  w-full md:w-3/5 lg:w-[44%]">
              ...
              >
                ...
                <div className="form-control pb-5 my-4 lg:mb-6">
                  ...
                  <Input
                    ...
                    {...register('service_name', {
                      required: {
                        value: true,
                        message: t('service_name_validation'),
                      },
                    })}
                  />
                ...
                <div className="form-control  mt-7 md:mt-10 lg:mt-10">
                  <button
                    disabled={isPending}
                    className={
                      !isPending
