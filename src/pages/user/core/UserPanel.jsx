    ...
    <div className="user-panel">
      ...
      <div className="panel">
        ...
        <div className="content">
          <h1 className="page-sub-title mb-14 text-black">{t('panel')} </h1>
          <div className="intro-user pb-10">
            <p className="text-black">
              <span className="hi" style={{ color: 'var(--color-blue-600)' }}>
                {t('welcome_our_client')}{' '}
              </span>
              {t('panel_description')}
            </p>
          ...
          <div className="summary-boxes flex justify-around">
            <div className="box">
              ...
              <div className="summary-count">
                <p className="text-black ml-2">{t('order_count')}</p>
              ...
              <div className="summary-action">
                <Link
                  to="/user-panel/orders"
                  className="link flex items-center gap-2 text-gray-600"
                >
                  <RiExternalLinkLine />
                  {t('show_orders')}
                </Link>
            ...
            <div className="box">
              ...
              <div className="summary-count">
                <p className="text-black ml-2">{t("report_count")}</p>
                {isPending ? (
                  <Spinner />
                ) : (
                  <span style={{ color: 'var(--color-blue-600)' }}>
